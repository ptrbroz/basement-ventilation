...
// NOTE: To be safe: call this, if you get a result disable interrupts, copy buffer, write \0, enable interrupts, then parse from own buffer.
// retval: length of string in buffer pointed to at bufferpointer, including \0. If no commands were waiting in queue, retval is 0 and NULL is written to bufferpointer.
